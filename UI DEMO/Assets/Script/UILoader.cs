...
public class UILoader : MonoBehaviour
{
    private void Update()
    {
        ...
        {
            if (SceneManager.GetSceneByName("UI - Stats").isLoaded == false)
                SceneManager.LoadSceneAsync("UI - Stats", LoadSceneMode.Additive);
            else
                SceneManager.UnloadSceneAsync("UI - Stats");
        }
